            ...
            if (x.name == "ALL") {
                ...
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        ...
                        document.getElementById('table-header').innerHTML = myJson[0].inst_name + ' (Registered Students) <a href="../Engine/admin_downloadCSV.php?token=<?php echo $_SESSION['session_token']; ?>&emis=' + x.name + '">Download CSV</a>';

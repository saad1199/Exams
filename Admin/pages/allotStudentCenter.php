                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div id="acct-password-row" class="span16">
                                ...
                                <label>Search Student CNIC</label>
                                <input type="text" id="stdId" name="stdId" value="" /><br><br>
                                <label>Search Student Name</label>
                                <input type="text" id="stdName" name="stdName" value="" />
                                <p id="bad-msg" class="text-danger" style="display:none;"><strong>Not Results</strong></p>
                                <p id="success-msg" style="display:none;" class="text-success"><strong>CNIC Verified</strong></p><br>
                                <br>
                            </div>
                        </div>
...
<script>
    ...
    $("#stdName").keyup(function() {
        ...
        $.ajax({
            url: '../Engine/getIncompleteStudent.php',
            data: {
                "token": "<?php echo $_SESSION['session_token']; ?>",
                "std_cnic": cnic,
...
<form class="form-horizontal" method="post" action="Engine/rs_update_student.php?sid=<?php echo $_GET['sid'] ?>" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-sm-9">
            <input required class="form-control w-100" type="text" name="fname" id="fname">
        </div>

        <br><br>
        <label class="col-sm-3 form-label">CNIC / B. Form Number</label>
        <div class="col-sm-9">
            <input required class="form-control" placeholder="12345-1234567-1" type="text" name="cnic" id="cnic" pattern="^[0-9+]{5}-[0-9+]{7}-[0-9]{1}$">
        </div>
        <br><br>
        ...
        <div class="col-sm-9">
            <div class="input-group mb-3"><span class="input-group-text">+92</span>
                <input placeholder="3XX-1234567" required class="form-control" pattern="3[0-9]{2}-(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" type="text" aria-label="Pakistani Mobile Number" name="contact" id="contact">
            </div>
        </div>
        <br><br>

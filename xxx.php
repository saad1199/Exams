                    ...
                    <div class="w-100">
                      <table class="w-100">
                       ...
                       $bform= $row['student_b_form'];
                                                      $path = "uploads/" .$bform. "-" . $row['student_name'] . ".jpg";
                                                      $path_jpeg = "uploads/" .$bform. "-" . $row['student_name'] . ".jpeg";

                                                      if (file_exists($path)) {
                                                        echo '<img  width="110" height="110" src="uploads/' .$bform. '-' . $row['student_name'] . '.jpg"      class="">';
                                                      } else if (file_exists($path_jpeg)) {
                                                        echo '<img  width="110" height="110" src="uploads/' .$bform. '-' . $row['student_name'] . '.jpeg"      class="">';
                                                      } else {
                        ...
                        <th class="w-50 text-right">
                          <!-- <h5 id="disp-name" class="text-s">Roll # <strong> echo //$row['reg_roll_no']; ?></strong></h5> -->
                          ...
                          <div class="">
                            <table class="wrapping-table h-100 mb-0">
                              <tbody id="basic-table-body">
                                  ...
                                  <td style="font-size:14px;"><?php echo "051".strtoupper($row['student_id']); ?></td>
                                </tr>
                                <tr>

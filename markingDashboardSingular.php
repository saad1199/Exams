...
$class = getClassFromCenterID($_SESSION['_____MARKINGCENTER_____ID'],$conn);
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-9">
                      <label class="col-sm-3 form-label">Enter Center (Starting)</label>
                    ...
                    <div class="row">
                    <h3 class="text-danger blink_me">Dear User ! Enter Marks very carefully. For Absent Students use Enter -1 Marks</h3>
                    </div>
                    ...
                    <thead>
                     ...
                     <h6 style="text-align:left; font-size: 11px;" class=""> <?php echo "Award List class ".$class."th - ".$subject." &nbsp;&nbsp;&nbsp;"?></h6>
                     ...
                     <tr>
                        ...
                        <th style="width:50%;">Marks in words</th>
                        <tr>
                      </thead>
                      <tbody id="stdBody">
  ...
  $.ajax({
            ...
            success: function(myJson) {
             var x = myJson[0].marked.marked;
              ...
              var percent=(x/y)*100;
              document.getElementById('progress-bar').innerHTML='<div id="progress-bar" class="progress-bar " role="progressbar" aria-valuenow="'+percent+'" style="width: '+percent+'%" aria-valuemin="0" aria-valuemax="100">'+percent+'</div>';
...
//Engine/ms_getStudentSeries.php?toSearchRollEnd='+eRoll+'&toSearchRollStart='+sRoll+'&token=
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'Engine/ms_getStudentSeriesSingular.php?center='+sRoll+'&token=<?php echo $_SESSION['_____USER_____KEY']; ?>');
                xhr.setRequestHeader('Content-Type', 'application/json');
                xhr.send();
                xhr.onload = function() {
                    if (xhr.status === 200) {
        ...
        if (myJson[i].class == "5") {
            countf++;
          str += '<tr>';
          str+='<td>'+countf+'</td><td>'+myJson[i].reg_roll_no+'</td><td class="toHide"><input onfocusout="updateMarks(this)" class="inpMarks" id="'+myJson[i].reg_roll_no+'" type="text"/></td><td class="fmarks" id="r'+myJson[i].reg_roll_no+'"></td><td id="w'+myJson[i].reg_roll_no+'"></td>';
          str += '</tr>';
            ...
            counte++;
          stre += '<tr>';
          stre+='<td>'+counte+'</td><td>'+myJson[i].reg_roll_no+'</td><td class="toHide"><input onfocusout="updateMarks(this)" class="inpMarks" id="'+myJson[i].reg_roll_no+'" type="text"/></td><td class="fmarks" id="r'+myJson[i].reg_roll_no+'"></td><td id="w'+myJson[i].reg_roll_no+'"></td>';

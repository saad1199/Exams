...
if($lock=='1'){
    ...
    if($grantAccess){
        ...
        header('location:../login.html?status=SESSION_EXPIRED'); exit(); 
    }
...
//    $sqld = "DELETE FROM BankChallan where challan_identifier='".$code."'";
...
} else { header('location:../login.html?status=SESSION_EXPIRED'); exit(); }
 ?>
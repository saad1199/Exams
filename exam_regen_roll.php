...
while ($rowIns = mysqli_fetch_assoc($insResult)) {
   ...
   SubjectCategory.class='5'  AND StudentRegistration.reg_challan_detail_challan_id=BankChallan.challan_id AND StudentRegistration.reg_allocated_center_inst_id='".$centerId."' AND BankChallan.isPaid=1;";

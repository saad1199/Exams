    ...
    <div class="page-content d-flex align-items-stretch">
      ...
      <nav class="side-navbar z-index-40">
        ...
        <ul class="list-unstyled py-4">
          ...
          <li class="sidebar-item"><a class="sidebar-link" href="registration.php">
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                <use xlink:href="#user-1"> </use>
              </svg>Late Registrations </a></li>
          <li class="sidebar-item active"><a class="sidebar-link" href="search.php">
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                <use xlink:href="#find-1"> </use>
              </svg>Students </a></li>
              <li class="sidebar-item"><a class="sidebar-link" href="downloads.php">
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
        ...
        <ul class="list-unstyled py-4">
          <li class="sidebar-item"> <a class="sidebar-link" href="admin-profile.php">
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                <use xlink:href="#imac-screen-1"> </use>
              </svg>Profile </a></li>
              <li class="sidebar-item"> <a class="sidebar-link" href="requests.php">
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                <use xlink:href="#settings-1"> </use>
              </svg>Check Requests Status </a></li>
          <li class="sidebar-item"> <a class="sidebar-link" href="changepassword.php">
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                <use xlink:href="#settings-1"> </use>
      ...
      <div class="content-inner w-100" style="background-image:url('assets/img/curved-images/white-curved.jpg');">
        <!-- Page Header-->
        <header class="bg-success text-white shadow-sm px-4 py-3 z-index-20">
  ...
  $.ajax({
    ...
    success: function(myJson) {
      ...
      for (var i = 0; i < myJson.length; i++) {
        ...
        xcode += '<td class="hidden-sm" style="width:15%;"><img class="shadow-0 img-fluid hidden-sm"  src="uploads/' + myJson[i].student_b_form + '-' + myJson[i].student_name + '.jpg"     onerror="this.onerror=null;this.src=\'uploads/' + myJson[i].student_b_form + '-' + myJson[i].student_name + '.jpeg\';" ></td>';
        xcode += '<td>';
        ...
        xcode += '<tr style="line-height:10px;"><th><a id="vbtn" class="btn btn-primary text-white w-100" href="profileView.php?bform=' + myJson[i].student_b_form + '&name=' + myJson[i].student_name + '&rollno=' + myJson[i].reg_roll_no + '&sid=' + myJson[i].student_id + '"/>View</a></th><td><a id="ebtn" class="btn btn-info text-white w-100" href="edit-ins-student.php?bform=' + myJson[i].student_b_form + '&name=' + myJson[i].student_name + '&rollno=' + myJson[i].reg_roll_no + '&sid=' + myJson[i].student_id + '"/>Edit</a></td><td><a class="btn btn-danger text-white w-100" data-bs-toggle="modal" data-s-name="'+myJson[i].student_name+'" data-s-id="'+myJson[i].student_id+'" data-bs-target="#my_modal" >Delete</a></td><td><a class="btn btn-danger text-white w-100" data-bs-toggle="modal" data-s-roll="'+myJson[i].reg_roll_no+'" data-s-id="'+myJson[i].student_id+'" data-bs-target="#my_modal_center" >Change Class/Center</a></td></tr>';
